...
public class WindParryOrb
    ...
    public void updateAnimation() {
        ...
        if (this.vfxTimer < 0.0F) {
            AbstractDungeon.effectList.add(new BetterFireBurstParticleEffect(this.cX, this.cY + this.bobEffect.y, 0.0F, 1.0F, 0.1F));
            this.vfxTimer = 0.07F;
        }
    }
