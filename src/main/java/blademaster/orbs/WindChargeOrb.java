...
public class WindChargeOrb
        extends AbstractOrb {
    public static final String ORB_ID = "WindCharge";
    ...
    public void update() {
        if (AbstractDungeon.player.hasPower(WindCharge.POWER_ID)) {
            this.passiveAmount = AbstractDungeon.player.getPower(WindCharge.POWER_ID).amount;
        } else {
