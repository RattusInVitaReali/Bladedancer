        ...
        if (CardCrawlGame.isInARun()) {
            ...
            if (AbstractDungeon.player.hasPower(IceStance.POWER_ID)) {
                if (__card_instance.hasTag(BlademasterTags.ICE_STANCE)) {
                    if (__card_instance.type == AbstractCard.CardType.ATTACK) {
                        Texture extraPowerBG = Blademaster.loadBgAddonTexture("blademasterResources/images/512/IceAttackSmall.png");
                    ...
                    if (__card_instance.type == AbstractCard.CardType.SKILL) {
                        Texture extraPowerBG = Blademaster.loadBgAddonTexture("blademasterResources/images/512/IceSkillSmall.png");
                        sb.setColor(reflectedColor);
                        sb.draw(extraPowerBG, x, y, 256f, 256f, 512f, 512f, __card_instance.drawScale * Settings.scale, __card_instance.drawScale * Settings.scale, __card_instance.angle, 0, 0, 512, 512, false, false);
                    }
                    if (__card_instance.type == AbstractCard.CardType.POWER) {
                        Texture extraPowerBG = Blademaster.loadBgAddonTexture("blademasterResources/images/512/IcePowerSmall.png");
                        sb.setColor(reflectedColor);
                        sb.draw(extraPowerBG, x, y, 256f, 256f, 512f, 512f, __card_instance.drawScale * Settings.scale, __card_instance.drawScale * Settings.scale, __card_instance.angle, 0, 0, 512, 512, false, false);
                    }
                }
            ...
            if (AbstractDungeon.player.hasPower(StoneStance.POWER_ID)) {
                if (__card_instance.hasTag(BlademasterTags.STONE_STANCE)) {
                    if (__card_instance.type == AbstractCard.CardType.ATTACK) {
                        Texture extraPowerBG = Blademaster.loadBgAddonTexture("blademasterResources/images/512/StoneAttackSmall.png");
                        sb.setColor(reflectedColor);
                        sb.draw(extraPowerBG, x, y, 256f, 256f, 512f, 512f, __card_instance.drawScale * Settings.scale, __card_instance.drawScale * Settings.scale, __card_instance.angle, 0, 0, 512, 512, false, false);
                    }
                    if (__card_instance.type == AbstractCard.CardType.SKILL) {
                        Texture extraPowerBG = Blademaster.loadBgAddonTexture("blademasterResources/images/512/StoneSkillSmall.png");
                        sb.setColor(reflectedColor);
                        sb.draw(extraPowerBG, x, y, 256f, 256f, 512f, 512f, __card_instance.drawScale * Settings.scale, __card_instance.drawScale * Settings.scale, __card_instance.angle, 0, 0, 512, 512, false, false);
                    }
                    if (__card_instance.type == AbstractCard.CardType.POWER) {
                        Texture extraPowerBG = Blademaster.loadBgAddonTexture("blademasterResources/images/512/StonePowerSmall.png");
                        sb.setColor(reflectedColor);
                        sb.draw(extraPowerBG, x, y, 256f, 256f, 512f, 512f, __card_instance.drawScale * Settings.scale, __card_instance.drawScale * Settings.scale, __card_instance.angle, 0, 0, 512, 512, false, false);
                    }
                }
