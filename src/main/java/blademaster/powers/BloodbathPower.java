...
public class BloodbathPower extends AbstractPower {
    ...
    public BloodbathPower(AbstractCreature owner, int amount) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("blademasterResources/images/powers/Bloodbath.png"), 0, 0, 84, 84);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("blademasterResources/images/powers/BloodbathSmall.png"), 0, 0, 32, 32);
        updateDescription();
    }
