...
public class EyeOfTheStormPower extends AbstractPower {
    ...
    public EyeOfTheStormPower(AbstractCreature owner, int amount) {
        ...
        this.region128 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("blademasterResources/images/powers/EyeOfTheStorm.png"), 0, 0, 84, 84);
        this.region48 = new TextureAtlas.AtlasRegion(ImageMaster.loadImage("blademasterResources/images/powers/EyeOfTheStormSmall.png"), 0, 0, 32, 32);
        updateDescription();
    }
