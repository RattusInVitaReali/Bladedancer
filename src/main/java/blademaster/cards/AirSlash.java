...
public class AirSlash extends CustomCard {


    public static final String ID = Blademaster.makeID("AirSlash");
    public static final String IMG = Blademaster.makePath("cards/AirSlash.png");
