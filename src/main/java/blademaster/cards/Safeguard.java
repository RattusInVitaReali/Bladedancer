...
public class Safeguard extends AbstractStanceCard {
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new Safeguard();
            this.cardToPreview2 = new Safeguard();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((Safeguard) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((Safeguard) this.cardToPreview2).LightningArtS = true;
