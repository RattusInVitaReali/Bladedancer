...
public class ThunderSlash extends CustomCard {


    public static final String ID = Blademaster.makeID("ThunderSlash");
    public static final String IMG = Blademaster.makePath("cards/ThunderSlash.png");
