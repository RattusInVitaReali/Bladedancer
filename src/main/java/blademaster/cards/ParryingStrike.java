...
public class ParryingStrike extends AbstractStanceCard {


    public static final String ID = Blademaster.makeID("ParryingStrike");
    public static final String IMG = Blademaster.makePath("cards/ParryingStrike.png");
    public static final String LIMG = Blademaster.makePath("cards/LightningParryingStrike.png");
    public static final String WIMG = Blademaster.makePath("cards/WindParryingStrike.png");
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new ParryingStrike();
            this.cardToPreview2 = new ParryingStrike();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((ParryingStrike) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((ParryingStrike) this.cardToPreview2).LightningArtS = true;
