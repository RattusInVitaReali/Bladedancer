...
public class BloodyBlow extends AbstractStanceCard {
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new BloodyBlow();
            this.cardToPreview2 = new BloodyBlow();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((BloodyBlow) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((BloodyBlow) this.cardToPreview2).LightningArtS = true;
