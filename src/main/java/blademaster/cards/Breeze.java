...
public class Breeze extends AbstractStanceCard {
    ...
    public static final String IMG = Blademaster.makePath("cards/Breeze.png");
    public static final String LIMG = Blademaster.makePath("cards/LightningBreeze.png");
    public static final String WIMG = Blademaster.makePath("cards/WindBreeze.png");
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new Breeze();
            this.cardToPreview2 = new Breeze();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((Breeze) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((Breeze) this.cardToPreview2).LightningArtS = true;
