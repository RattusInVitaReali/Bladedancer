...
public class DragonStrike extends AbstractStanceCard {
    ...
    public static final String ID = Blademaster.makeID("DragonStrike");
    public static final String IMG = Blademaster.makePath("cards/DragonStrike.png");
    public static final String LIMG = Blademaster.makePath("cards/LightningDragonStrike.png");
    public static final String WIMG = Blademaster.makePath("cards/WindDragonStrike.png");
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        ...
        AbstractDungeon.actionManager.addToBottom(new ApplyPowerAction(p, p, new ComboPower(p, this.magicNumber), this.magicNumber));
    }
