...
public class AwakeningDefend extends AbstractStanceCard {
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new AwakeningDefend();
            this.cardToPreview2 = new AwakeningDefend();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((AwakeningDefend) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((AwakeningDefend) this.cardToPreview2).LightningArtS = true;
