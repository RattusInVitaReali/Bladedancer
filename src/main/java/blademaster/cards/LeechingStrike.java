...
public class LeechingStrike extends AbstractStanceCard {


    public static final String ID = Blademaster.makeID("LeechingStrike");
    public static final String IMG = Blademaster.makePath("cards/LeechingStrike.png");
    public static final String WIMG = Blademaster.makePath("cards/LeechingStrike.png");
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new LeechingStrike();
            this.cardToPreview2 = new LeechingStrike();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((LeechingStrike) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((LeechingStrike) this.cardToPreview2).LightningArtS = true;
