...
public class Lacerate extends AbstractStanceCard {
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new Lacerate();
            this.cardToPreview2 = new Lacerate();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((Lacerate) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((Lacerate) this.cardToPreview2).LightningArtS = true;
