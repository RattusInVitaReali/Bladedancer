...
public class DaggerAndCloak extends AbstractStanceCard {
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new DaggerAndCloak();
            this.cardToPreview2 = new DaggerAndCloak();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((DaggerAndCloak) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((DaggerAndCloak) this.cardToPreview2).LightningArtS = true;
