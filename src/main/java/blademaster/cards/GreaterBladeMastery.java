...
public class GreaterBladeMastery extends CustomCard {


    public static final String ID = Blademaster.makeID("GreaterBladeMastery");
    ...
    public AbstractCard makeCopy() {
        return new GreaterBladeMastery();
    }
