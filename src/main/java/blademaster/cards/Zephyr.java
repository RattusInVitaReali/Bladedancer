...
public class Zephyr extends AbstractStanceCard {
    ...
    public static final String IMG = Blademaster.makePath("cards/Zephyr.png");
    public static final String LIMG = Blademaster.makePath("cards/LightningZephyr.png");
    public static final String WIMG = Blademaster.makePath("cards/WindZephyr.png");
    ...
    public void hover() {
        if (this.cardToPreview1 == null && ! this.bullshit) {
            this.cardToPreview1 = new Zephyr();
            this.cardToPreview2 = new Zephyr();
            if (this.upgraded || SingleCardViewPopup.isViewingUpgrade) {
                this.cardToPreview1.upgrade();
                this.cardToPreview2.upgrade();
            }
            ((Zephyr) this.cardToPreview1).WindArtS = true;
            this.cardToPreview1.update();
            ((Zephyr) this.cardToPreview2).LightningArtS = true;
