...
public class RandomOffensiveStancePerkBlight extends AbstractBlight implements PerkBlight {
    ...
    public RandomOffensiveStancePerkBlight() {
        super(ID, NAME, DESCRIPTION[0], "defaultModResources/images/relics/perks/OffensiveStanceMasteryPerk.png", true);
        this.img = ImageMaster.loadImage("defaultModResources/images/relics/perks/OffensiveStanceMasteryPerk.png");
